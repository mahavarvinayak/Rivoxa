      ...
      <nav className="border-b bg-white/80 backdrop-blur-lg shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="https://i.postimg.cc/3wBgmcH3/Chat-Flow-Logo-new.png" alt="ChatFlow AI" className="h-8 w-8" />
      ...
      <footer className="border-t bg-card py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <img src="https://i.postimg.cc/3wBgmcH3/Chat-Flow-Logo-new.png" alt="ChatFlow AI" className="h-6 w-6" />
